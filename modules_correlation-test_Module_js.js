"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["modules_correlation-test_Module_js"],{
...
/* harmony export */ });
/* harmony import */ var _img_moduleCorrelation_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./img/moduleCorrelation.png */ "./modules/correlation-test/img/moduleCorrelation.png");
...
class Module extends _modules_AbstractModule__WEBPACK_IMPORTED_MODULE_3__["default"] {
    ...
    static #image = _img_moduleCorrelation_png__WEBPACK_IMPORTED_MODULE_0__;
    ...
    #testChoose(isInv, alpha, arg) {
        ...
        try {
            switch (this.#testType) {
                ...
                case 'spearman': {
                    if (this.#inputType !== 'manual' && firstVarName !== _data_Var__WEBPACK_IMPORTED_MODULE_4__["default"].Rang.name) {
                        throw new Error(errorText([_data_Var__WEBPACK_IMPORTED_MODULE_4__["default"].Rang.ruName]));
                    }
                    if (isInv) {
...
/***/ "./modules/correlation-test/img/moduleCorrelation.png":
/*!************************************************************!*\
  !*** ./modules/correlation-test/img/moduleCorrelation.png ***!
  \************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "f000561d4f327acaf4e7.png";

/***/ })

}]);
//# sourceMappingURL=modules_correlation-test_Module_js.js.map